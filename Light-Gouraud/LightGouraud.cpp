...
init(void)
{
	...
	Program = new Shader("media/shaders/light/gouraud/box.vert", "media/shaders/light/gouraud/box.frag");
	LightProgram = new Shader("media/shaders/light/gouraud/light.vert", "media/shaders/light/gouraud/light.frag");
}
void
display(void)
{
